...
public class CryptoCurrencyConvertionBean {
	...
	public CryptoCurrencyConvertionBean(String id, String name, String convertTo, BigDecimal price_btc,
			BigDecimal price_usd, BigDecimal quantity, BigDecimal calculatedAmount, int port) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "CryptoCurrencyConvertionBean [id=" + id + ", name=" + name + ", convertTo=" + convertTo + ", price_btc="
				...
				+ calculatedAmount + ", port=" + port + ", getId()=" + getId() + ", getName()=" + getName()
				+ ", getConvertTo()=" + getConvertTo() + ", getPrice_btc()=" + getPrice_btc() + ", getPrice_usd()="
				+ getPrice_usd() + ", getQuantity()=" + getQuantity() + ", getCalculatedAmount()="
				+ getCalculatedAmount() + ", getPort()=" + getPort() + ", getClass()=" + getClass() + ", hashCode()="
